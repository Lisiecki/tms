# TMS - Testing Finite-Memory Strategies for Petri Games
# Copyright (C) 2022 Dennis Lisiecki
...
# For questions regarding how to use the program, refer to the manual in the github repository Lisiecki/tms
import sys, getopt
import copy
import config
import time
